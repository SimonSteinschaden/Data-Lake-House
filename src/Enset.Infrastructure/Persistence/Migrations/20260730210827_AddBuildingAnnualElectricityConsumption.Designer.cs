...
namespace Enset.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730210827_AddBuildingAnnualElectricityConsumption")]
    partial class AddBuildingAnnualElectricityConsumption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Enset.Domain.Associations.AssociationAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssociationType", "SourceId", "TargetId", "ChangedAtUtc");

                    b.ToTable("AssociationAuditHistory", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.Associations.BuildingDocumentAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BuildingId", "DocumentId", "ValidFrom")
                        .IsUnique();

                    b.ToTable("BuildingDocumentAssignments", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.Associations.BuildingMeterAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MeterId", "IsPrimary");

                    b.HasIndex("ValidFrom", "ValidTo");

                    b.HasIndex("BuildingId", "MeterId", "ValidFrom")
                        .IsUnique();

                    b.ToTable("BuildingMeterAssignments", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.Associations.CustomerProjectAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CustomerId", "ProjectId", "ValidFrom")
                        .IsUnique();

                    b.ToTable("CustomerProjectAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("Enset.Domain.Buildings.BuildingVersion", b =>
                {
                    ...
                    b.Property<decimal?>("AnnualElectricityConsumptionKWh")
                        .HasPrecision(18, 2)
            ...
            modelBuilder.Entity("Enset.Domain.Common.EntityAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Enset.Domain.Curation.CurationDecision", b =>
                {
                    ...
                    b.Property<Guid>("CurationTaskId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CurationTaskId", "DecidedAtUtc");

                    b.ToTable("CurationDecisions", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.Curation.CurationTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CurationTasks", (string)null);
                });
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProduct", b =>
                {
                    ...
                    b.ToTable("DataProducts", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductCustomerAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DataProductCustomerAssignment");
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DataProductDefinitions", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductDefinitionScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DataProductDefinitionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DataProductDefinitionId");

                    b.ToTable("DataProductDefinitionScope");
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductGenerationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DataProductGenerationRuns", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductScopeAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DataProductScopeAssignments", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DataProductVersionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DataProductVersionId");

                    b.ToTable("DataProductValues", (string)null);
                });

            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("InputPeriodFrom")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("InputPeriodTo")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("DataProductId", "VersionNumber")
                        .IsUnique();

                    b.ToTable("DataProductVersions", (string)null);
                });
            ...
            modelBuilder.Entity("Enset.Domain.Energy.EnergySystemBuildingAssignment", b =>
                {
                    ...
                    b.HasIndex("EnergySystemId", "IsPrimary");

                    b.HasIndex("BuildingId", "EnergySystemId", "ValidFrom")
                        .IsUnique();

                    b.ToTable("EnergySystemBuildingAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("Enset.Infrastructure.Imports.MassImport.ImportStagingMeterReading", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("EnergyDirection")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<string>("MeterNumberOriginal")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.HasIndex("ImportId", "BatchNumber");

                    b.HasIndex("ImportId", "ValidationStatus");

                    b.HasIndex("MeterId", "Timestamp");

                    b.HasIndex("ImportId", "MeterId", "Timestamp");

                    b.HasIndex("ImportId", "MeterId", "Timestamp", "SourceRowNumber");

                    b.ToTable("ImportStagingMeterReadings", (string)null);
                });

            modelBuilder.Entity("Enset.Infrastructure.Imports.MassImport.MeterReadingImportAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ImportId", "MeterId");

                    b.ToTable("MeterReadingImportAudits", (string)null);
                });

            modelBuilder.Entity("Enset.Infrastructure.Imports.MassImport.MeterReadingImportJobEntity", b =>
                {
                    b.Property<Guid>("JobId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<long>("ReadRows")
                        .HasColumnType("bigint");

                    b.Property<long>("RejectedRows")
                        .HasColumnType("bigint");

                    b.Property<long>("StagedRows")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ValidRows")
                        .HasColumnType("bigint");

                    b.Property<long>("WrittenRows")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MeterReadingImportJobs", (string)null);
                });
            ...
            modelBuilder.Entity("Enset.Domain.Associations.BuildingDocumentAssignment", b =>
                {
                    ...
                    b.HasOne("Enset.Domain.Documents.Document", "Document")
            ...
            modelBuilder.Entity("Enset.Domain.Curation.CurationDecision", b =>
                {
                    b.HasOne("Enset.Domain.Curation.CurationTask", "Task")
                        .WithMany("Decisions")
                        .HasForeignKey("CurationTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProduct", b =>
                {
                    b.HasOne("Enset.Domain.DataProducts.DataProductDefinition", "Definition")
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductCustomerAssignment", b =>
                {
                    ...
                    b.HasOne("Enset.Domain.DataProducts.DataProduct", "DataProduct")
                        .WithMany("CustomerAssignments")
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductDefinitionScope", b =>
                {
                    b.HasOne("Enset.Domain.DataProducts.DataProductDefinition", "DataProductDefinition")
                        .WithMany("AllowedScopes")
                        .HasForeignKey("DataProductDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DataProductDefinition");
                });
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductValue", b =>
                {
                    b.HasOne("Enset.Domain.DataProducts.DataProductVersion", "DataProductVersion")
                        .WithMany("Values")
                        .HasForeignKey("DataProductVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DataProductVersion");
                });
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductVersion", b =>
                {
                    ...
                    b.HasOne("Enset.Domain.DataProducts.DataProductGenerationRun", "GenerationRun")
                        .WithMany("GeneratedVersions")
            ...
            modelBuilder.Entity("Enset.Domain.DataProducts.DataProductGenerationRun", b =>
                {
                    b.Navigation("GeneratedVersions");
                });
